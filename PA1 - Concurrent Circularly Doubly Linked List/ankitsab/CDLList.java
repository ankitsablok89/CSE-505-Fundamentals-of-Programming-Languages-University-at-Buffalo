...
public class CDLList<T> {
	...
	public class Element {
		...
		// pointer
		private volatile T nodeValue;
		private volatile Element nodeNext;
		private volatile Element nodePrevious;

		// this is a proprietary read/write lock for the object, this will help
		// us in implementing the fine grain functionality
		ReadWriteLocks rwLock = new ReadWriteLocks();
	...
	// this method returns an cursor to a specific element in the cdllist
	...
	public class Cursor {
		...
		private volatile Element cursorPosition;
	...
	public class Writer {
		...
		private volatile Element writerPosition;
